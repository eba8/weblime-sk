...
<main class="mx-auto pt-16 sm:pt-24 lg:pt-28">
  <div class="sm:pt-16 lg:pt-8 lg:pb-14">
    <div class="text-center">
      ...
      >
        <span class="block xl:inline">Build. Launch. Grow.</span>
        <!-- <span class="rounded-md bg-primary-500 px-3 xl:inline"
          >your growth.</span
        > -->
      </h1>
      <p
        class="mx-auto mt-3 max-w-md text-base text-slate-600 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl"
      >
        A Maryland web design & development company that partners with brands
        like yours to create digital experiences that help your business grow.
      </p>
      <div class="mx-auto mt-5 max-w-md sm:flex sm:justify-center md:mt-8">
        ...
        <div class="mt-3 rounded-md sm:mt-0 sm:ml-3">
          <a
            href="/get-in-touch"
            class="border-transparent flex w-full items-center justify-center rounded-md border bg-slate-900 px-8 py-3 text-base font-medium text-white hover:bg-slate-800 md:py-4 md:px-10 md:text-lg"
          >
            Get In Touch
          </a>
        </div>
              ...
              <div class="flow-root rounded-lg bg-red-100 px-6 pb-8">
                <div class="-mt-8">
                  ...
                  <p class="mt-5 text-base text-gray-600">
                    We are driven by creativity and passion. To truly represent
                    your business, our team will work with you to bring your
                    dreams into reality.
                  </p>
                </div>
              </div>
            ...
            <div class="mt-6">
              <div class="mt-6 flow-root rounded-lg bg-primary-100 px-6 pb-8">
                <div class="-mt-8">
                  ...
                  <p class="mt-5 text-base text-gray-600">
                    Capitalize on your market potential and gauge interest among
                    your clientele by implmementing advanced techonlogical
                    solutions.
                  </p>
                </div>
              </div>
            ...
            <div class="mt-12">
              <div class="mt-6 flow-root rounded-lg bg-yellow-100 px-6 pb-8">
                <div class="-mt-8">
                  ...
                  <p class="mt-5 text-base text-gray-600">
                    Enhance your reach with creative marketing strategies and
                    campaigns. Reach the right people, with the right message,
                    at the right time.
                  </p>
                </div>
              </div>
