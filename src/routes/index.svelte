    ...
    <div class="text-center">
      ...
      <div class="max-w-md mx-auto mt-5 sm:flex sm:justify-center md:mt-8">
        ...
        <div class="mt-3 rounded-md sm:mt-0 sm:ml-3">
          <a
            href="/get-in-touch"
            class="flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white bg-gray-900 border border-transparent rounded-md hover:bg-gray-200 md:py-4 md:text-lg md:px-10"
          >
            Get In Touch
          </a>
        </div>
