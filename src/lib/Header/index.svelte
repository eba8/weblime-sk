...
<header>
        <div class:theme-lime={$page.path === '/solutions' } class:theme-black={$page.path === '/portfolio'} class="relative pt-6 pb-16 sm:pb-24 lg:pb-32 bg-skin-hero">
				...
				<div class="flex items-center flex-1">
                  ...
                  />
						...
						<div class="flex items-center -mr-2 md:hidden">
							<button on:click={()=>{ mobile_menu = !mobile_menu }} type="button" class="inline-flex items-center justify-center p-2 text-gray-400 rounded-md bg-gray-50 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500 mobile-menu-open" aria-expanded="false">
			...
			<div class="hidden md:block md:ml-10 md:space-x-10">
				<a sveltekit:prefetch href="/solutions" class="font-medium text-skin-base hover:text-skin-text-base-hover" class:active={$page.path === '/solutions'}>Solutions</a>
				<a sveltekit:prefetch href="/portfolio" class="font-medium text-skin-base hover:text-skin-text-base-hover" class:active={$page.path === '/portfolio'}>Portfolio</a>
			</div>
		</div>
	...
	<!-- {#if mobile_menu }
		...
		<li class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" class:active={$page.path === '/solutions'}><a on:click = {()=>{mobile_menu = !mobile_menu}} sveltekit:prefetch href="/solutions">Solutions</a></li>

		<li class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" class:active={$page.path === '/portfolio'}><a on:click = {()=>{mobile_menu = !mobile_menu}} sveltekit:prefetch href="/portfolio">Portfolio</a></li> 
		</div>
  	{/if} -->
	  {#if mobile_menu }
	 <!-- MOBILE MENU -->
	 <div class="absolute inset-x-0 top-0 p-2 overflow-visible transition origin-top-right transform">
		<div class="bg-white rounded-lg shadow-md ring-1 ring-black ring-opacity-5">
		  <div class="flex items-center justify-between px-5 pt-4">
			<div>
				<a href="/">
					<svg class="fill-current h-9 w-9 text-primary-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 250"
				stroke="currentColor" aria-hidden="true">
						<path
							stroke-linecap="round"
							stroke-linejoin="round"
			...
			<div class="-mr-2">
			  <button type="button" class="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500">
				<span class="sr-only">Close main menu</span>
				<!-- Heroicon name: outline/x -->
				<svg on:click = {()=>{mobile_menu = !mobile_menu}} class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
		  ...
		  <div class="px-2 pt-2 pb-3 space-y-1">
			<a href="/" class="block px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:text-gray-900 hover:bg-gray-50">Solutions</a>
			<a href="/" class="block px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:text-gray-900 hover:bg-gray-50">Portfolio</a>
		  </div>
		  <a href="/" class="block w-full px-5 py-3 rounded-b-md font-medium text-center text-primary-600 bg-gray-100 hover:bg-gray-100">
			Get In Touch
		  </a>
		</div>
	  </div>  
