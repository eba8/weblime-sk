...
<header>
  ...
  <!-- {#if mobile_menu }
		...
		<li class="bg-gray-50 border-gray-500 text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" class:active={$page.url === '/'}><a on:click = {()=>{mobile_menu = !mobile_menu}} sveltekit:prefetch href="/">Home</a></li>
		<li class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" class:active={$page.url === '/solutions'}><a on:click = {()=>{mobile_menu = !mobile_menu}} sveltekit:prefetch href="/solutions">Solutions</a></li>

		<li class="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium" class:active={$page.url === '/portfolio'}><a on:click = {()=>{mobile_menu = !mobile_menu}} sveltekit:prefetch href="/portfolio">Portfolio</a></li> 
		</div>
  	{/if} -->
  {#if mobile_menu}
    <!-- MOBILE MENU -->
      ...
      >
        <div class="flex items-center justify-between px-5 pt-4">
          <div>
            <a href="/" target="home">
              <svg
                class="fill-current h-9 w-9 text-primary-500"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 250 250"
                stroke="currentColor"
                aria-hidden="true"
