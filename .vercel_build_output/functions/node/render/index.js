...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
    ...
    Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<header><div class="${[
        "relative bg-skin-hero pt-6 pb-16 sm:pb-24 lg:pb-32",
        ...
        <div class="${"hidden md:ml-10 md:block md:space-x-10"}"><a sveltekit:prefetch href="${"/solutions"}" class="${"font-medium text-skin-base hover:text-skin-text-base-hover"}">Solutions</a>
          <a sveltekit:prefetch href="${"/portfolio"}" class="${"font-medium text-skin-base hover:text-skin-text-base-hover"}">Portfolio</a></div></div>
      <div class="${"hidden text-right md:block"}"><span class="${"inline-flex rounded-md"}"><a sveltekit:prefetch href="${"/get-in-touch"}" class="${"inline-flex items-center rounded-md bg-skin-fill px-5 py-2 text-base font-medium text-skin-inverted"}">Get In Touch
          </a></span></div></nav></div>
  ...
  ${``}</header>`;
    ...
    Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<footer><div class="${"mx-auto max-w-7xl overflow-hidden px-4 py-12 sm:px-6 lg:px-8"}"><nav class="${"-mx-5 -my-2 flex flex-wrap justify-center"}" aria-label="${"Footer"}"><div class="${"px-5 py-2"}"><a href="${"/"}" class="${"text-base text-gray-500 hover:text-gray-900"}">Home
        </a></div>
    ...
    <div class="${"mt-8 flex justify-center space-x-6"}"><a href="${"https://www.facebook.com/weblimeworld"}" class="${"text-gray-600 hover:text-gray-800"}"><span class="${"sr-only"}">Facebook</span>
    ...
    <p class="${"mt-8 text-center text-base text-gray-600"}">\xA9 ${escape(year)} WebLime, Inc. All rights reserved.
    </p></div></footer>`;
    });
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    entry = "pages/__layout.svelte-ef4fdaaa.js";
    js = ["pages/__layout.svelte-ef4fdaaa.js", "chunks/index-457e8868.js", "chunks/stores-106c960d.js"];
    css = ["assets/pages/__layout.svelte-8ee493bf.css"];
  }
});
...
var init_slug_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/stories/_slug_.svelte.js"() {
    ...
    U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${$$result.head += `${$$result.title = `<title>${escape(post.title)} - WebLime</title>`, ""}<meta name="${"title"}" content="${escape(post.title) + " - WebLime"}" data-svelte="svelte-jj0hdh"><meta name="${"description"}"${add_attribute("content", post.meta_description, 0)} data-svelte="svelte-jj0hdh"><meta property="${"og:locale"}" content="${"en_US"}" data-svelte="svelte-jj0hdh"><meta property="${"og:type"}" content="${"website"}" data-svelte="svelte-jj0hdh"><meta property="${"og:site_name"}" content="${"WebLime - Digital Agency"}" data-svelte="svelte-jj0hdh"><meta property="${"og:url"}" content="${"https://www.weblime.com/stories/" + escape(post.slug)}" data-svelte="svelte-jj0hdh"><meta property="${"og:title"}" content="${escape(post.title) + " - WebLime"}" data-svelte="svelte-jj0hdh"><meta property="${"og:description"}"${add_attribute("content", post.meta_description, 0)} data-svelte="svelte-jj0hdh"><meta property="${"twitter:card"}" content="${"summary_large_image"}" data-svelte="svelte-jj0hdh"><meta name="${"twitter:site"}" content="${"@weblime_agency"}" data-svelte="svelte-jj0hdh"><meta property="${"twitter:title"}" content="${escape(post.title) + " - WebLime"}" data-svelte="svelte-jj0hdh"><meta property="${"twitter:description"}"${add_attribute("content", post.meta_description, 0)} data-svelte="svelte-jj0hdh">${post.feature_image ? `<meta property="${"og:image"}"${add_attribute("content", post.feature_image, 0)} data-svelte="svelte-jj0hdh">
    <meta property="${"twitter:image"}"${add_attribute("content", post.feature_image, 0)} data-svelte="svelte-jj0hdh">` : `<meta property="${"og:image"}" content="${"https://www.weblime.com/images/seo/weblime-digital-agency.jpg"}" data-svelte="svelte-jj0hdh">
    <meta property="${"twitter:image"}" content="${"https://www.weblime.com/images/seo/weblime-digital-agency.jpg"}" data-svelte="svelte-jj0hdh">`}`, ""}
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/9.js"() {
    init_slug_svelte();
    index3 = 9;
    entry3 = "pages/stories/_slug_.svelte-2af5e1e0.js";
    js3 = ["pages/stories/_slug_.svelte-2af5e1e0.js", "chunks/index-457e8868.js", "chunks/index-e95dc991.js", "chunks/project-In-mind-e3a18454.js"];
    css3 = [];
  }
});
...
var manifest = {
  ...
  _: {
    entry: { "file": "start-7b500489.js", "js": ["start-7b500489.js", "chunks/index-457e8868.js"], "css": [] },
    nodes: [
