...
// .svelte-kit/output/server/chunks/index-38cedc01.js
function noop2() {
}
function run(fn) {
  return fn();
...
// .svelte-kit/output/server/chunks/stores-f780dc53.js
var getStores, page;
var init_stores_f780dc53 = __esm({
  ".svelte-kit/output/server/chunks/stores-f780dc53.js"() {
    init_index_38cedc01();
    getStores = () => {
...
var init_layout_svelte = __esm({
  ...
  ${``}</header>`;
    ...
    Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<footer><div class="${"px-4 py-12 mx-auto overflow-hidden max-w-7xl sm:px-6 lg:px-8"}"><nav class="${"-mx-5 -my-2 flex flex-wrap justify-center"}" aria-label="${"Footer"}"><div class="${"px-5 py-2"}"><a href="${"/"}" class="${"text-base text-gray-500 hover:text-gray-900"}">Home
        </a></div>

      <div class="${"px-5 py-2"}"><a sveltekit:prefetch href="${"/stories/"}" class="${"text-base text-gray-500 hover:text-gray-900"}">Stories
        </a></div>
      <div class="${"px-5 py-2"}"><a href="${"/get-in-touch/"}" class="${"text-base text-gray-500 hover:text-gray-900"}">Get In Touch
        </a></div></nav>
    <div class="${"flex justify-center mt-8 space-x-6"}"><a href="${"https://www.facebook.com/weblimeworld"}" class="${"text-gray-600 hover:text-gray-800"}"><span class="${"sr-only"}">Facebook</span>
      ...
      <a href="${"https://twitter.com/weblime_agency"}" class="${"text-gray-600 hover:text-gray-800"}"><span class="${"sr-only"}">Twitter</span>
        <svg class="${"w-6 h-6"}" fill="${"currentColor"}" viewBox="${"0 0 24 24"}" aria-hidden="${"true"}"><path d="${"M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"}"></path></svg></a>
      <a href="${"https://www.instagram.com/weblimeworld"}" class="${"text-gray-600 hover:text-gray-800"}"><span class="${"sr-only"}">Instagram</span>
    ...
    <p class="${"mt-8 text-base text-center text-gray-600"}">\xA9 ${escape(year)} WebLime, Inc. All rights reserved.
    </p></div></footer>`;
    });
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    entry2 = "pages/__error.svelte-fa96706f.js";
    js2 = ["pages/__error.svelte-fa96706f.js", "chunks/index-457e8868.js"];
    css2 = [];
  }
});
...
var init_project_In_mind_cc64b809 = __esm({
  ".svelte-kit/output/server/chunks/project-In-mind-cc64b809.js"() {
    init_index_38cedc01();
    Project_In_mind = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"mx-auto max-w-fit px-4 sm:px-6 lg:px-8"}"><div class="${"mx-auto "}"><div class="${"rounded-lg bg-gray-900 px-6 py-8 sm:p-10 lg:flex lg:items-center"}"><div class="${"flex-1"}"><h2 class="${"text-3xl font-extrabold tracking-tight text-white sm:text-4xl"}"><span class="${"block"}">Got a project in mind?</span>
          <span class="${"block text-primary-500"}">We deliver solutions that drive your business forward.</span></h2></div>
...
// .svelte-kit/output/server/entries/pages/stories/_slug_.svelte.js
...
<main class="${"mx-auto"}">
  <div class="${"sm:pt-16 lg:pt-8 lg:pb-14"}"><div class="${"mx-auto flex max-w-5xl flex-col items-center pb-5 text-center lg:flex-row lg:text-left"}"><h1 class="${"px-5 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl"}">${escape(post.title)}</h1>
...
// .svelte-kit/output/server/entries/endpoints/sitemap.xml.js
...
// .svelte-kit/output/server/entries/endpoints/get-in-touchh.js
var get_in_touchh_exports = {};
var init_get_in_touchh = __esm({
  ".svelte-kit/output/server/entries/endpoints/get-in-touchh.js"() {
  }
});
...
var require_main = __commonJS({
  "node_modules/dotenv/lib/main.js"(exports, module2) {
    ...
    function config(options) {
      ...
      try {
        const parsed = parse3(fs.readFileSync(dotenvPath, { encoding }), { debug });
        Object.keys(parsed).forEach(function(key2) {
          if (!Object.prototype.hasOwnProperty.call(process.env, key2)) {
            ...
            log(`"${key2}" is already defined in \`process.env\` and will not be overwritten`);
          }
        });
        return { parsed };
      } catch (e2) {
...
// .svelte-kit/output/server/entries/endpoints/stories/ghost_stories.js
var ghost_stories_exports = {};
__export(ghost_stories_exports, {
  get: () => get2
});
async function get2() {
  const api = new import_content_api.default({
    url: API_URL,
    key: GHOST_KEY,
    version: "v4.0"
  });
...
var import_content_api, import_dotenv, GHOST_KEY, API_URL;
var init_ghost_stories = __esm({
  ".svelte-kit/output/server/entries/endpoints/stories/ghost_stories.js"() {
    import_content_api = __toESM(require_content_api(), 1);
    import_dotenv = __toESM(require_main(), 1);
    import_dotenv.default.config();
    ({ GHOST_KEY, API_URL } = process.env);
  }
});
...
var manifest = {
  ...
  _: {
    entry: { "file": "start-bc59b754.js", "js": ["start-bc59b754.js", "chunks/index-457e8868.js"], "css": [] },
    nodes: [
    ...
    routes: [
      ...
      {
        type: "endpoint",
        id: "stories/ghost_stories",
        pattern: /^\/stories\/ghost_stories\/?$/,
        names: [],
        types: [],
